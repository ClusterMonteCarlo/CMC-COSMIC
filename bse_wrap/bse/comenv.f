...
*
      ...
      REAL*8 bkick(16),fallback,ecsnp,ecsn_mlow,M1i,M2i
...
*
            ...
            IF(KW2.GE.13)THEN
               ...
               KW2 = 15
               AJ1 = 0.D0
* CLR - if the secondary is a BH, give the newly formed BH the spin of
* the inspiraling one
               IF(KW1.EQ.14) bhspin1 = bhspin2
*
