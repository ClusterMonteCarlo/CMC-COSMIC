...
void bse_set_taus113state(struct rng_t113_state state, int first) {
  ...
  taus113state_.state[0]= state.z1;
  taus113state_.state[1]= state.z2;
  taus113state_.state[2]= state.z3;
  taus113state_.state[3]= state.z4;
...
struct rng_t113_state bse_get_taus113state(void) {
  ...
  state.z1= taus113state_.state[0];
  state.z2= taus113state_.state[1];
  state.z3= taus113state_.state[2];
  state.z4= taus113state_.state[3];
