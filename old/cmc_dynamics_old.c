...
void perturb_stars_fewbody(double dt, gsl_rng *rng)
{
	...
	double vr=0.0, vt=0.0, vrp=0.0, vtp=0.0, Ai;
	...
	fb_units_t bs_fb_units, bs_cmc_units, bb_fb_units, bb_cmc_units;
				...
				*/
				...
				if (rng_t113_dbl() < P_enc) { /* check if bin-bin interaction is DUE */
					...
					if (BINBIN_FEWBODY) {
						...
						bb_cmc_units.v = sqrt((m+mp)/(m*mp)*(binary[star[k].binind].m1*binary[star[k].binind].m2/binary[star[k].binind].a + binary[star[kp].binind].m1*binary[star[kp].binind].m2/binary[star[kp].binind].a)/((double) clus.N_STAR));
						bb_cmc_units.l = binary[star[k].binind].a + binary[star[kp].binind].a;
						bb_cmc_units.t = bb_cmc_units.l / bb_cmc_units.v;
						bb_cmc_units.m = bb_cmc_units.l * sqr(bb_cmc_units.v);
						bb_cmc_units.E = bb_cmc_units.m * sqr(bb_cmc_units.v);
								...
								if (bb_hier.nobj == 1) {
									...
									if ((fb_n_hier(bb_hier.obj[0]) == 2)&&(fb_n_hier(bb_hier.obj[1]) == 2)) {
										...
										if ((bb_hier.obj[0]->obj[0]->id[0]==0 && bb_hier.obj[0]->obj[1]->id[0]==1)||
											...
											binary[star[k].binind].a = bb_hier.obj[0]->a * bb_cmc_units.l;
											binary[star[k].binind].e = bb_hier.obj[0]->e;
											binary[star[kp].binind].a = bb_hier.obj[1]->a * bb_cmc_units.l;
											binary[star[kp].binind].e = bb_hier.obj[1]->e;
											
											/* figure out new velocities */
											for (j=1; j<=3; j++) {
												vnew[j] = vcm[j] + bb_cmc_units.v * alpha * 
													(bb_hier.obj[0]->v[0] * wx[j] + bb_hier.obj[0]->v[1] * wy[j] + bb_hier.obj[0]->v[2] * wz[j]);
												vpnew[j] = vcm[j] + bb_cmc_units.v * alpha * 
											...
											gzprintf(binbinfile, "final:\toutcome=preservation\n");
											/* set new binary props, keeping binaries at same radii in cluster */
											binary[star[k].binind].a = bb_hier.obj[1]->a * bb_cmc_units.l;
											binary[star[k].binind].e = bb_hier.obj[1]->e;
											binary[star[kp].binind].a = bb_hier.obj[0]->a * bb_cmc_units.l;
											...
											binary[star[k].binind].a = bb_hier.obj[0]->a * bb_cmc_units.l;
											binary[star[k].binind].e = bb_hier.obj[0]->e;
											binary[star[k].binind].m1 = bb_hier.obj[0]->obj[0]->m * bb_cmc_units.m / madhoc;
											binary[star[k].binind].m2 = bb_hier.obj[0]->obj[1]->m * bb_cmc_units.m / madhoc;
											binary[star[kp].binind].a = bb_hier.obj[1]->a * bb_cmc_units.l;
											binary[star[kp].binind].e = bb_hier.obj[1]->e;
											binary[star[kp].binind].m1 = bb_hier.obj[1]->obj[0]->m * bb_cmc_units.m / madhoc;
											binary[star[kp].binind].m2 = bb_hier.obj[1]->obj[1]->m * bb_cmc_units.m / madhoc;
										...
										gzprintf(binbinfile, "final:\ta=%.6g e=%.6g\n", 
											 bb_hier.obj[tid]->obj[bid]->a * bb_cmc_units.l * units.l / FB_CONST_AU,
										...
										if ((bb_hier.obj[tid]->obj[bid]->obj[0]->id[0]==0 && bb_hier.obj[tid]->obj[bid]->obj[1]->id[0]==1)||
											...
											binary[star[k].binind].a = bb_hier.obj[tid]->obj[bid]->a * bb_cmc_units.l;
											...
											/* assign other stars */
											mp = star[kp].m = bb_hier.obj[sid]->m * bb_cmc_units.m / madhoc;
											mpp = star[kpp].m = bb_hier.obj[tid]->obj[s1id]->m * bb_cmc_units.m / madhoc;
											rpp = star[kp].r;
											star[kpp].r = rpp;
											...
											for (j=1; j<=3; j++) {
												...
												vppnew[j] = vcm[j] + bb_cmc_units.v * alpha * 
													(vtrip[0] * wx[j] + vtrip[1] * wy[j] + vtrip[2] * wz[j]);
											}
											...
											binary[star[kp].binind].a = bb_hier.obj[tid]->obj[bid]->a * bb_cmc_units.l;
											...
											/* assign other stars */
											m = star[k].m = bb_hier.obj[sid]->m * bb_cmc_units.m / madhoc;
											mpp = star[kpp].m = bb_hier.obj[tid]->obj[s1id]->m * bb_cmc_units.m / madhoc;
											rpp = star[k].r;
											star[kpp].r = rpp;
											...
											binary[star[k].binind].a = bb_hier.obj[tid]->obj[bid]->a * bb_cmc_units.l;
											binary[star[k].binind].e = bb_hier.obj[tid]->obj[bid]->e;
											binary[star[k].binind].m1 = bb_hier.obj[tid]->obj[bid]->obj[0]->m * bb_cmc_units.m / madhoc;
											binary[star[k].binind].m2 = bb_hier.obj[tid]->obj[bid]->obj[1]->m * bb_cmc_units.m / madhoc;
									...
									/* print some info */
									gzprintf(binbinfile, "final:\ta=%.6g e=%.6g\n", 
										 bb_hier.obj[bid]->a * bb_cmc_units.l * units.l / FB_CONST_AU,
										 bb_hier.obj[bid]->e);
									...
									if ((bb_hier.obj[bid]->obj[0]->id[0]==0 && bb_hier.obj[bid]->obj[1]->id[0]==1)||
										...
										/*** unprimed binary is preserved ***/
										/**************************************************************/
										binary[star[k].binind].a = bb_hier.obj[bid]->a * bb_cmc_units.l;
										...
										/* assign other stars */
										mp = star[kp].m = bb_hier.obj[s1id]->m * bb_cmc_units.m / madhoc;
										mpp = star[kpp].m = bb_hier.obj[s2id]->m * bb_cmc_units.m / madhoc;
										rpp = star[kp].r;
										star[kpp].r = rpp;
										star[kpp].phi = star[kp].phi;
										vrpp = star[kp].vr;
										...
										/*** primed binary is preserved ***/
										/**************************************************************/
										binary[star[kp].binind].a = bb_hier.obj[bid]->a * bb_cmc_units.l;
										...
										/* assign other stars */
										m = star[k].m = bb_hier.obj[s1id]->m * bb_cmc_units.m / madhoc;
										mpp = star[kpp].m = bb_hier.obj[s2id]->m * bb_cmc_units.m / madhoc;
										rpp = star[k].r;
										star[kpp].r = rpp;
										star[kpp].phi = star[k].phi;
										...
										binary[star[k].binind].a = bb_hier.obj[bid]->a * bb_cmc_units.l;
										binary[star[k].binind].e = bb_hier.obj[bid]->e;
										binary[star[k].binind].m1 = bb_hier.obj[bid]->obj[0]->m * bb_cmc_units.m / madhoc;
										binary[star[k].binind].m2 = bb_hier.obj[bid]->obj[1]->m * bb_cmc_units.m / madhoc;
		...
		if ((star[k].binind > 0 && star[kp].binind == 0) || (star[k].binind == 0 && star[kp].binind > 0)) {
			...
			if (rng_t113_dbl() < P_enc) {
				...
				if (BINSINGLE_FEWBODY) {
					...
					bs_cmc_units.v = sqrt((m+mp)/(m*mp) * 
							     (binary[star[k].binind].m1 * binary[star[k].binind].m2 / binary[star[k].binind].a) / 
							     ((double) clus.N_STAR));
					bs_cmc_units.l = binary[star[k].binind].a;
					bs_cmc_units.t = bs_cmc_units.l / bs_cmc_units.v;
					bs_cmc_units.m = bs_cmc_units.l * sqr(bs_cmc_units.v);
					bs_cmc_units.E = bs_cmc_units.m * sqr(bs_cmc_units.v);
					...
					if (fabs(bs_retval.DeltaEfrac) > 0.01) {
						...
						if (bs_hier.nstar == 3) {
							...
							if (bs_hier.nobj == 3) {
								...
								m = star[k].m = bs_hier.obj[0]->m * bs_cmc_units.m / madhoc;
								mp = star[kp].m = bs_hier.obj[1]->m * bs_cmc_units.m / madhoc;
								mpp = star[kpp].m = bs_hier.obj[2]->m * bs_cmc_units.m / madhoc;
								rpp = star[kp].r;
								star[kpp].r = rpp;
								star[kpp].phi = star[kp].phi;
								vrpp = star[kp].vr;
								...
								binary[star[k].binind].m1 = bs_hier.obj[bid]->obj[0]->m * bs_cmc_units.m / madhoc;
								binary[star[k].binind].m2 = bs_hier.obj[bid]->obj[1]->m * bs_cmc_units.m / madhoc;
								star[k].m = binary[star[k].binind].m1 + binary[star[k].binind].m2;
								binary[star[k].binind].a = bs_hier.obj[bid]->a * bs_cmc_units.l;
								binary[star[k].binind].e = bs_hier.obj[bid]->e;
								
								/* set star's properties */
								star[kp].m = bs_hier.obj[sid]->m * bs_cmc_units.m / madhoc;
