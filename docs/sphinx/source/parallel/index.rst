...
-------------------------------------
It is very necessary to read `Pattabiraman et al. (2013) <https://ui.adsabs.harvard.edu/abs/2013ApJS..204...15P/abstract>`_ before proceeding. The paper covers most of the code and parallelization aspects which in itself serves as a guide for development. Here, we cover some more low level coding details to aid a developer who wants to modify the code. An introduction to MPI might also be very useful, and in fact necessary for any non-trivial code development. 
