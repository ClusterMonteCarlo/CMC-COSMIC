...
``rtmsflag``             Activates different prescriptions for stellar radius at main sequence turnoff
                            ``0`` : uses the SSE rtms for M < 200M_sun and extrapolation for z < 0.0008 and M>200m_sun.
                            ``1`` : interpolates the rtms from Boost tracks (Szécsi et al. (2022)). Extrapolation is used after M > 575 M_sun
