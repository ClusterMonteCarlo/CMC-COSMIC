...
AC_ARG_ENABLE(fast-math, [AC_HELP_STRING([--enable-fast-math], [enable compiler optimizations that violate IEEE standards])],
	acx_maxopt_fmath=$withval, acx_maxopt_fmath=no)
