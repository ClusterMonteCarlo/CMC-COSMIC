...
#define FB_M10 (5.0 * FB_CONST_MSUN)
#define FB_M11 (0.2 * FB_CONST_MSUN)

#define FB_R00 (10.0 * FB_CONST_RSUN)
#define FB_R01 (1.0 * FB_CONST_RSUN)
#define FB_R10 (5.0 * FB_CONST_RSUN)
#define FB_R11 (0.2 * FB_CONST_RSUN)
...
#define FB_B 1.1 /* in units of a_0 + a_1 */
