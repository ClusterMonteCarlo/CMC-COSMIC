...
_EXTERN_ int BSE_CEMERGEFLAG, BSE_CEKICKFLAG, BSE_CEHESTARFLAG, BSE_CEFLAG, BSE_TFLAG, BSE_IFFLAG, BSE_WDFLAG, BSE_BHFLAG, BSE_BHSPINFLAG, BSE_NSFLAG, BSE_IDUM, BSE_WINDFLAG, BSE_QCFLAG, BSE_ECSN, BSE_ECSN_MLOW, BSE_EDDLIMFLAG, BSE_AIC, BSE_REJUVFLAG, BSE_USSN;
