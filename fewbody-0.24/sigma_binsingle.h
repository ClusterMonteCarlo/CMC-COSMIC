...
#define FB_PRECISION 0.1 /* fractional precision on cross section */
...
/* a useful structure for calculating cross sections */
typedef struct{
	double sigma_r; /* resonant cross section */
	double dsigma2_r_minus; /* negative uncertainty squared */
	double dsigma2_r_plus; /* positive uncertainty squared */
	double sigma_nr; /* non-resonant cross section */
	double dsigma2_nr_minus; /* negative uncertainty squared */
	double dsigma2_nr_plus; /* positive uncertainty squared */
} fb_sigma_t;
