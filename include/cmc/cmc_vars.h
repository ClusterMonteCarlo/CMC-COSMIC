...
_EXTERN_ FILE *binaryfile, *threebbfile, *threebbprobabilityfile, *lightcollisionfile, *threebbdebugfile, *binintfile, *collisionfile, *pulsarfile, *morepulsarfile, *morecollfile, *bhlossconefile, *triplefile, *tidalcapturefile, *tdefile, *semergedisruptfile, *removestarfile, *relaxationfile;
...
_EXTERN_ MPI_File mpi_logfile, mpi_binintfile, mpi_escfile, mpi_collisionfile, mpi_pulsarfile, mpi_morepulsarfile, mpi_morecollfile, mpi_bhlossconefile, mpi_triplefile, mpi_tidalcapturefile, mpi_tdefile, mpi_semergedisruptfile, mpi_removestarfile, mpi_relaxationfile;
...
*/
_EXTERN_ long long mpi_logfile_len, mpi_escfile_len, mpi_binintfile_len, mpi_collisionfile_len, mpi_pulsarfile_len, mpi_morepulsarfile_len, mpi_morecollfile_len, mpi_bhlossconefile_len, mpi_triplefile_len, mpi_tidalcapturefile_len, mpi_tdefile_len, mpi_semergedisruptfile_len, mpi_removestarfile_len, mpi_relaxationfile_len;
