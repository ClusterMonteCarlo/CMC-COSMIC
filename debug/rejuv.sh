../utils/mkking/mkking -w 4 -N 1000000 -o /tmp/test1.fits -s 659139000
...
cmc_addbinaries -i /tmp/test4.fits -o ../k4k_0.1_4_b10_n1e5.fits -N 100000 -l 0 && rm /tmp/test4.fits
